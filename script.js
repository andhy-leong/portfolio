...
const translations = {
  fr: {
    ...
    "apropos-texte1": "Étudiant en troisième année de BUT Informatique, spécialisé dans le développement d'applications et de logiciels.",
    "apropos-texte2": "Au cours de ma formation et à travers divers projets académiques, de solides compétences en développement backend et frontend ont été développées, ainsi qu'une ouverture vers d'autres domaines comme le réseau, la cryptographie et les bases de l'intelligence artifielle.",
  ...
  en: {
    ...
    "apropos-texte1": "Third-year student in Computer Science, specializing in application and software development.",
    "apropos-texte2": "During the training period and through various academic projects, strong backend and frontend development skills were built, along with exposure to other fields such as networking, cryptography, and the fundamentals of artificial intelligence.",
  ...
  mg: {
    ...
    "apropos-texte1": "Mpianatra taona fahatelo amin’ny sehatry ny Informatika, misampana amin’ny fampivoarana rindranasa sy rindrambaiko.",
    "apropos-texte2": "Mandritra ny fiofanana sy ireo tetikasa akademika samihafa dia nivoatra ny fahaiza-manao matanjaka amin’ny fampivoarana backend sy frontend, ary koa ny fahalalana fototra momba ny sehatra hafa toy ny tambajotra, ny kaody miafina, ary ny fototry ny faharanitan-tsaina artifisialy.",
