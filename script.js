...
const translations = {
  fr: {
    ...
    "apropos-texte2":
      "Au cours de ma formation et à travers divers projets académiques, de solides compétences en développement backend et frontend ont été développées, ainsi qu'une ouverture vers d'autres domaines comme le réseau, la cryptographie et les bases de l'intelligence artifielle.",
    ...
    "paires-desc":
      "Développement d'un jeu de paires en langage C, en utilisant la bibliothèque ncurses pour l'interface terminal.",
    "websaver-desc":
      "Réalisation d'un outil en Java pour télécharger l'intégralité d'un site web (fichiers HTML, CSS et JS) à partir de son URL.",
    "webcompress-desc":
      "Extension du projet WebPageSaver permettant de compresser les fichiers téléchargés afin d'optimiser le stockage.",
    "ecommerce-desc":
      "Conception d'une plateforme e-commerce structurée autour du pattern d'architecture MVVM pour garantir une séparation claire des responsabilités.",
    "erp-desc":
      "Création d'un ERP pour la gestion d'une station-service, avec un front-end réactif en Vue.js et un back-end en PHP.",
    "blindtest-desc":
      "Réalisation d'une application de blind test interactive qui interroge l'API de Deezer pour les extraits musicaux et gère les réponses en temps réel via des appels REST.",
    "quiz-desc":
      "Architecture d'une application de quiz full-stack, combinant un front-end en React et un back-end robuste en Java (Spring Boot) qui communiquent via une API REST.",
    "mouton-desc":
      "Conception d'un jeu de cartes multijoueur, incluant une gestion réseau complexe pour synchroniser un plateau central, des écrans de joueurs, un mode espion et des bots à difficulté variable.",
  ...
  en: {
    ...
    "apropos-texte2":
      "During the training period and through various academic projects, strong backend and frontend development skills were built, along with exposure to other fields such as networking, cryptography, and the fundamentals of artificial intelligence.",
    ...
    "paires-desc":
      "Developed a memory game in C, featuring a terminal-based user interface powered by the ncurses library.",
    "websaver-desc":
      "Built a Java-based tool to download the entire content of a website, including all HTML, CSS, and JavaScript files, from a given URL.",
    "webcompress-desc":
      "Enhanced the WebPageSaver project by adding an automatic file compression feature to optimize storage space.",
    "ecommerce-desc":
      "Engineered an e-commerce platform using the MVVM architectural pattern to ensure a clear separation of concerns and maintainable code.",
    "erp-desc":
      "Created a comprehensive ERP system for managing a gas station, featuring a responsive front-end built with Vue.js and a back-end powered by PHP.",
    "blindtest-desc":
      "Developed an interactive music quiz application that queries the Deezer API for song clips and manages real-time answers through REST API calls.",
    "quiz-desc":
      "Architected a full-stack quiz application combining a React front-end with a robust Java (Spring Boot) back-end, communicating via a REST API.",
    "mouton-desc":
      "Designed a multiplayer card game with complex network management to synchronize a central game board, player screens, a spectator mode, and bots with varying difficulty levels.",
    ...
    "exp1-titre":
      "Intern - IMREDD (Mediterranean Institute for Risk, Environment and Sustainable Development)",
  ...
  mg: {
    ...
    "apropos-texte2":
      "Mandritra ny fiofanana sy ireo tetikasa akademika samihafa dia nivoatra ny fahaiza-manao matanjaka amin’ny fampivoarana backend sy frontend, ary koa ny fahalalana fototra momba ny sehatra hafa toy ny tambajotra, ny kaody miafina, ary ny fototry ny faharanitan-tsaina artifisialy.",
    ...
    "paires-desc":
      "Famolavolana lalao mitady tsiroaroa amin'ny fiteny C, mampiasa ny tranomboky ncurses ho an'ny seho eo amin'ny terminal.",
    "websaver-desc":
      "Famoronana fitaovana amin'ny Java ahafahana maka ny votoatin'ny tranonkala iray manontolo avy amin'ny URL-ny.",
    "webcompress-desc":
      "Fanitarana ny tetikasa WebPageSaver amin'ny alàlan'ny famatrarana ho azy ireo rakitra nalaina mba hitsitsiana toerana.",
    "ecommerce-desc":
      "Famolavolana sehatra e-varotra miorina amin'ny maodely MVVM mba hiantohana ny fizarana andraikitra mazava.",
    "erp-desc":
      "Famoronana ERP ho an'ny fitantanana tobin-tsolika, miaraka amin'ny Vue.js ho an'ny 'front-end' ary PHP ho an'ny 'back-end'.",
    "blindtest-desc":
      "Fanaovana rindrambaiko 'blind test' mifandray amin'ny API an'i Deezer mba hakana hira sy hitantanana valiny haingana.",
    "quiz-desc":
      "Fananganana rindrambaiko 'quiz' feno, mampifandray ny React amin'ny 'front-end' sy Java (Spring Boot) amin'ny 'back-end'.",
    "mouton-desc":
      "Famolavolana lalao karatra misy rafitra tambajotra mba hampifandrindrana ny sehatra foibe sy ny efijerin'ny mpilalao.",
    "multimedia-desc":
    ...
    "exp1-titre":
      "Mpiofana - IMREDD (Institut Méditerranéen du Risque de l’Environnement et du Développement Durable)",
